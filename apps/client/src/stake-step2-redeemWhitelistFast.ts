...
async function run() {
    ...
    const shares = parseUnits("5", 18); // Burn 5 sTESTUSD shares

    console.log("🚀 Executing Whitelisted Instant Redeem (Shares -> Assets)...");
    ...
    console.log(`✅ Instant Redemption complete: ${hash}`);
}
