...
async function run() {
    ...
    console.log("🛠️ Step 1: Approving TESTUSD for request...");
    ...
    console.log("⏳ Step 2: Initiating 7-day Cooldown Request...");
    ...
    console.log(`\n⚠️ You must wait 7 days. After that, you can run the 'redeem' script to get your USDC.`);
}
